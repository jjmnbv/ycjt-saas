 ...
 */
public class CreditCarrierHighFreqListVo implements Serializable {
    ...
    public CreditCarrierHighFreqListVo(SaasCreditCarrierRecordVo saasCreditCarrierRecordVo, List<CreditBmpMatchVo> creditBmpMatchVos) {
