...
public class SaasCreditBmpDetailVo implements ResponseData, Serializable {
    ...
    public static SaasCreditBmpDetailVo convertEntityToVO(SaasCreditBmpDetail saasCreditBmpDetail) {
        if (saasCreditBmpDetail == null) {
            return null;
        }
        SaasCreditBmpDetailVo saasCreditBmpDetailVo = new SaasCreditBmpDetailVo();
        BeanUtils.copyProperties(saasCreditBmpDetail, saasCreditBmpDetailVo);
        saasCreditBmpDetailVo.setSaasCreditBmpDetailId(saasCreditBmpDetail.getId());
        return saasCreditBmpDetailVo;
    }

    public static SaasCreditBmpDetail convertVOToEntity(SaasCreditBmpDetailVo saasCreditBmpDetailVo) {
        if (saasCreditBmpDetailVo == null) {
            return null;
        }
        SaasCreditBmpDetail saasCreditBmpDetail = new SaasCreditBmpDetail();
        BeanUtils.copyProperties(saasCreditBmpDetailVo, saasCreditBmpDetail);
        saasCreditBmpDetail.setId(saasCreditBmpDetailVo.getSaasCreditBmpDetailId());
        return saasCreditBmpDetail;
    }
