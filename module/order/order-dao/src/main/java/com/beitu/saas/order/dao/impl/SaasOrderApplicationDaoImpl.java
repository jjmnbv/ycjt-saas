...
public class SaasOrderApplicationDaoImpl extends AbstractBaseMapper<SaasOrderApplication> implements SaasOrderApplicationDao {
    ...
    @Override
    public SaasOrderApplication selectByBorrowerCode(String borrowerCode) {
        return this.getSqlSession().selectOne(this.getStatement(".selectByBorrowerCode"), borrowerCode);
    }
