...
public class DecimalUtils {
    ...
    public static double round(BigDecimal v) {
        BigDecimal ne = new BigDecimal("1");
        return v.divide(ne, 2, BigDecimal.ROUND_HALF_UP).doubleValue();
    }
     ...
     * @return
     */
    public static String floatToPercent(BigDecimal b) {
        DecimalFormat df = new DecimalFormat("0.0%");
        String percent = df.format(b);
    ...
    public static void main(String[] args) {
        String s = DecimalUtils.floatToPercent(BigDecimal.valueOf(0.01));
        System.out.print(s);
    }
